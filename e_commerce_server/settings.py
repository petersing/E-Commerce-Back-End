...
IMAGE_SERVER_URL = "http://localhost:8000/api/Product/Image/"
...
# Please Create A PostgreSQL server
...
### Please Create Redis Server

CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.10.103:6379/8",
        "OPTIONS": {
...
CHANNEL_LAYERS = {
     "default": {
         ...
         "CONFIG": {
             "hosts": [os.environ.get('REDIS_URL', 'redis://192.168.10.103:6379/1')],
         },
     },
 }
...
### Please Create Stripe Key according to stripe instruction
...
### Please Create a secret_key with enough length, min 20
...
### Please Create a Google client ID
